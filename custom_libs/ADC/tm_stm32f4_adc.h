...
/**
 * @brief  Enables the temperature sensor channel(ADC1_IN18)
 * @param  None
 * @retval None
 */
...
/**
 * @brief  Disables the internal temperature sensor(ADC1_IN18)
 * @param  None
 * @retval None
 */
...
/**
 * @brief  Reads and converts internal temperature sensor pin voltage
 * @param  None
 * @retval temperature in degrees celcius
 */
